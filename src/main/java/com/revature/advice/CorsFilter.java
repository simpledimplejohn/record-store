...
// for cross origin resource failure issues when a front end and back end app are running together
// appends the headders for all methods
// common class included in all apps
